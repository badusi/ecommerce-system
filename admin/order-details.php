...
// Get order items
$query = "SELECT oi.*, p.name, p.description, p.image_url 
          FROM order_items oi 
            ...
            <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 30px;">
                ...
                <div>
                    ...
                    <div style="background: white; padding: 20px; border-radius: 10px; box-shadow: 0 5px 15px rgba(0,0,0,0.1);">
                        ...
                        <p style="margin-top: 15px;"><?php echo nl2br(htmlspecialchars($order['shipping_address'])); ?></p>
                    </div>
                </div>
                ...
                <div>
                    <div style="background: white; padding: 20px; border-radius: 10px; box-shadow: 0 5px 15px rgba(0,0,0,0.1); margin-bottom: 20px;">
                        ...
                        <div style="border-top: 2px solid #3498db; padding-top: 15px; margin-top: 15px;">
                    ...
                    <?php if ($transaction): ?>
                        <div style="background: white; padding: 20px; border-radius: 10px; box-shadow: 0 5px 15px rgba(0,0,0,0.1); margin-bottom: 20px;">
                            ...
                            <div style="margin-top: 15px;">
                                ...
                                <p><strong>Gateway:</strong> <?php echo ucwords(str_replace('_', ' ', $transaction['payment_gateway'])); ?></p>
                                <p><strong>Status:</strong> 
                    ...
                    <div style="background: white; padding: 20px; border-radius: 10px; box-shadow: 0 5px 15px rgba(0,0,0,0.1);">
                        <h3>Quick Actions</h3>
                        <div style="margin-top: 15px;">
                            <a href="user-details.php?id=<?php echo $order['user_id']; ?>" class="btn btn-primary" style="width: 100%; margin-bottom: 10px; text-align: center; display: block; text-decoration: none;">View Customer</a>
                            <?php if ($transaction): ?>
                                <a href="transactions.php" class="btn btn-secondary" style="width: 100%; text-align: center; display: block; text-decoration: none;">View All Transactions</a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
