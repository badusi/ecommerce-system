...
$query = "SELECT u.*, 
          CASE 
            WHEN u.role = 'staff_goods' THEN (SELECT COUNT(*) FROM products WHERE created_by = u.id)
                            ...
                            <?php foreach ($staff as $member): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php 
                                            if ($member['role'] == 'staff_goods') {
                                                echo $member['activity_count'] . ' products created';
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="new_role" id="modalNewRole" required>
                        <option value="staff_goods">Product Manager</option>
