        ...
        <main class="content">
            ...
            <?php if (empty($products)): ?>
                <div style="text-align: center; padding: 50px; background: white; border-radius: 10px; box-shadow: 0 5px 15px rgba(0,0,0,0.1);">
                    ...
                    <a href="dashboard.php" class="btn btn-primary" style="margin-top: 20px;">View All Products</a>
                </div>
            <?php else: ?>
                <?php foreach ($categories as $category_name => $category_products): ?>
                    <section style="margin-bottom: 40px;">
                        <h3 style="color: #2c3e50; margin-bottom: 20px; border-bottom: 2px solid #3498db; padding-bottom: 10px;">
                            📂 <?php echo htmlspecialchars($category_name); ?> (<?php echo count($category_products); ?> items)
                        </h3>
                            ...
                            <?php foreach ($category_products as $product): ?>
                                <div class="product-card">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <p style="color: #666; margin-bottom: 10px;"><?php echo htmlspecialchars($product['description']); ?></p>
                                        ...
                                        <div class="delivery-info">
                                            <?php if ($product['availability'] === 'store'): ?>
                                                🏪 In Store - Delivery: <?php echo $product['delivery_days_min']; ?>-<?php echo $product['delivery_days_max']; ?> working days
                                            <?php else: ?>
                                                🚢 Shipped - Delivery: <?php echo $product['delivery_days_min']; ?>-<?php echo $product['delivery_days_max']; ?> working days
                                            <?php endif; ?>
                                        </div>
                                        <button onclick="addToCart(<?php echo $product['id']; ?>)" class="btn btn-primary" style="width: 100%; margin-top: 10px;">
                                            🛒 Add to Cart
                                        </button>
                                    </div>
                                </div>
